...
// clear / compact / resume. Those three lifecycle actions swap `committed` wholesale
...
// copy above it (the auto-compaction / resume duplication bug). Owning the escape in
 ...
 *  terminal instead of stacking a second copy above the old one. TTY-gated: a
